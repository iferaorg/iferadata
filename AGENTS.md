...
## Linters
- Use pyright to check for any static typing errors. Fix any errors & warnings from pyright. You may use "ignore hints" as a last resort, to disable type checking on a line.
...
- Use bandit to scan for security issues and fix any errors and warnings.
